...
<body class='is-loading'>
    ...
    <!-- RSVP -->
      <section id="rsvp" class="main style3 secondary">
        <div class="content container">
          <header>
            <h2>RSVP</h2>
          ...
          <!-- RSVP Form -->
            ...
            <form method="" action="#">
                ...
                <div class="row 50%">
                  <div class="12u"><textarea name="notes" placeholder="Anything Else You Want to Tell Us?" rows="6"></textarea></div>
                </div>
                <div class="row">
                  <div class="12u">
                    <ul class="actions">
